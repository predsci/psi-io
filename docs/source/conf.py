...
exclusions = [
    ...
    "psi_io._models.ModelType",
    "psi_io._models._PROP_GETTER_MAPPING",
    "psi_io._models._BASE_SCALE_PROPS_MAPPING",
    "psi_io._models.ModelProps._mesh",

    "psi_io._mesh._MESH_CODE_REVERSE_MAPPING",
    "psi_io._mesh._coerce_mesh_target",
...
numpydoc_xref_aliases = {
    ...
    # --- psi_io_models ---
    "ScaleProps": "psi_io._models.ScaleProps",
    "ModelProps": "psi_io._models.ModelProps",
